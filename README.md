...
This is an **unofficial, third-party application** created for personal use 
and shared freely with the community. It is not affiliated with, endorsed by, 
or connected to Google LLC or YouTube.

This application is simply a web wrapper that provides desktop integration 
features (Discord Rich Presence, media keys, custom window) for the official 
YouTube Music web player. It does not modify, intercept, or interfere with 
YouTube Music's service in any way.

**YouTube** and the **YouTube logo** are registered trademarks of Google LLC.

This project is provided free of charge and will remain free forever. 
No monetization, no ads, no data collection.
